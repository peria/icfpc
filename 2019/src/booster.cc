...
Booster charToBooster(const char c) {
  switch (c) {
  case 'B': return Booster::kManipulator;
  case 'F': return Booster::kFastWheel;
  case 'L': return Booster::kDrill;
  case 'C': return Booster::kCloning;
  case 'R': return Booster::kBeacon;
  default:
